...
import com.psw.exam.demo.service.ReactionPointService;
import com.psw.exam.demo.service.ReplyService;
import com.psw.exam.demo.util.Ut;
import com.psw.exam.demo.vo.Article;
import com.psw.exam.demo.vo.Board;
import com.psw.exam.demo.vo.Reply;
...
public class UsrArticleController {
	...
	public String showList(Model model, @RequestParam(defaultValue = "1") int boardId, @RequestParam(defaultValue = "title,body") String searchKeywordTypeCode, @RequestParam(defaultValue = "") String searchKeyword,
		...
		List<Article> articles = articleService.getForPrintArticles(rq.getLoginedMemberId(), boardId, itemsCountInAPage, searchKeywordTypeCode, searchKeyword,
				page);
