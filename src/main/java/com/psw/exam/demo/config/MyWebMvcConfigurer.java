...
import com.psw.exam.demo.interceptor.NeedLogoutInterceptor;
...
public class MyWebMvcConfigurer implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		ir.addPathPatterns("/usr/reactionPoint/doCancleGoodReaction");
		ir.addPathPatterns("/usr/reactionPoint/doCancleBadReaction");
