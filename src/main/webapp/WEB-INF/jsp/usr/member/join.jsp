...
<section class="grid min-h-screen place-items-center">
      ...
      onsubmit="MemberJoin__submit(this); return false;">
        <input type="hidden" name="loginPw" />
          ...
          <input id="nickname" type="text" name="nickname" placeholder="별명을 입력해주세요." autocomplete="nickname" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
