...
<div class="grid min-h-screen place-items-center">
      <div class="w-11/12 p-12 bg-white sm:w-8/12 md:w-1/2 lg:w-5/12">
        ...
        <form class="mt-6" method="POST" action="../member/doJoin"
      onsubmit="MemberJoin__submit(this); return false;">
        <input type="hidden" name="loginPw" />
        
          <label for="loginId" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">Loginid</label>
          ...
          <input id="password" type="password" name="loginPwConfirm" placeholder="********" autocomplete="new-password" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
          ...
          <input id="name" type="text" name="name" placeholder="이름을 입력해주세요." autocomplete="name" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />

          <label for="nickname" class="block mt-2 text-xs font-semibold text-gray-600 uppercase">Nickname</label>
          <input id="nickname" type="text" name="nickname" placeholder="별명을 입력해주세요." autocomplete="loginId" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />
          ...
          <input id="tel" type="tel" name="tel" placeholder="휴대폰 번호를 입력해주세요." autocomplete="loginId" class="block w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner" required />

          <button type="submit" class="w-full py-3 mt-6 font-medium tracking-widest text-white uppercase bg-black shadow-lg focus:outline-none hover:bg-gray-900 hover:shadow-none">
            Sign up
          </button>

          <p class="flex justify-between inline-block mt-4 text-xs text-gray-500 cursor-pointer hover:text-black" onclick="history.back();">Already registered?</p>
        </form>
      </div>
  </div>
